 ...
 * events from the Insteon Hub. Insteon Sensors are broadcast only, so device
 * status requests will not be attempted.
 * 
 * @author Eric Thill
 * @since 1.4.1
 */
public class InsteonHubDigitalSensor extends InsteonHubDevice {
